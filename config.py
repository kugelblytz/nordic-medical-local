...
EVIDENCE_REFINEMENT_ENABLED = _env_bool('EVIDENCE_REFINEMENT_ENABLED', False)
EVIDENCE_REFINEMENT_TIMEOUT = float(os.getenv('EVIDENCE_REFINEMENT_TIMEOUT', '90'))
EVIDENCE_REFINEMENT_NUM_PREDICT = int(os.getenv('EVIDENCE_REFINEMENT_NUM_PREDICT', '900'))
